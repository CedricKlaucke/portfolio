  ...
  return (
    <AnimatePresence>
      {toggleNav && (
        <>
          <motion.aside
            className="fixed flex flex-col w-64 h-full top-0 left-0 border-r shadow-md z-20 text-black-0 bg-white dark:text-white dark:bg-black-200 dark:border-black-300"
